...
/** `id` → etichette i18n `contact_link_${id}`; `lineKey` → `contact_line_*` */
export const contactLinks = [
  { id: 'email', href: `mailto:${personal.email}`, value: personal.email },
  { id: 'github', href: personal.github, value: 'MichelBranche' },
  { id: 'linkedin', href: personal.linkedin, lineKey: 'linkedin' },
  { id: 'discord', href: personal.discord, value: personal.discordUsername },
  { id: 'instagram', href: personal.instagram, lineKey: 'instagram' },
  { id: 'facebook', href: personal.facebook, lineKey: 'facebook' },
]
...
export const contactFormApiUrl = '/api/send-message'
export const statsApiUrl = '/api/stats'

export const bottomFeaturedProjectId = 1
